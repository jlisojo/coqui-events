...
class Simple_Events_Settings {
    ...
    public function register() {
        ...
        add_settings_field(
            'per_page',
            __('Events per page', 'coqui-events'),
        ...
        add_settings_field(
            'currency_symbol',
            __('Currency symbol', 'coqui-events'),
    ...
    public function add_page() {
        add_submenu_page(
            ...
            __('Event Settings', 'coqui-events'),
            __('Settings', 'coqui-events'),
            'manage_options',
    ...
    public function render_page() {
        ...
        ?>
        <div class="wrap">
            <h1><?php esc_html_e('Event Settings', 'coqui-events'); ?></h1>
            <form action="options.php" method="post">
                <?php
                settings_fields('simple_events');
                do_settings_sections('coqui-events');
                submit_button();
                ?>
            </form>
        </div>
    ...
    public function render_slug_field() {
        ...
        <p class="description">
            ...
            printf(
                ...
                esc_html__('Used in event permalinks and the archive URL, e.g. %s', 'coqui-events'),
    ...
    public function render_date_format_field() {
        ...
        <p class="description"><?php esc_html_e('Leave blank to use the WordPress date format from Settings → General.', 'coqui-events'); ?></p>
        <?php
    }
}
