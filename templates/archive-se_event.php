    ...
    <div class="se-archive__inner">
        ...
        <div class="se-grid">
            <?php if (have_posts()) : ?>
                ...
                ?>
            <?php else : ?>
                <p class="se-empty"><?php esc_html_e('No upcoming events found. Check back soon.', 'coqui-events'); ?></p>
            <?php endif; ?>
        </div>
        ...
        the_posts_pagination(array(
            'mid_size'  => 2,
            'prev_text' => __('← Previous', 'coqui-events'),
            'next_text' => __('Next →', 'coqui-events'),
        ));
        ?>
        ...
        <?php if ($se_past_query->have_posts()) : ?>
            <section class="se-past">
                <button class="se-past__toggle" type="button" aria-expanded="false" aria-controls="se-past-grid">
                    <h2><?php esc_html_e('Past Events', 'coqui-events'); ?></h2>
